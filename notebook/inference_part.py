...
class Inference_Part:
    ...
    def __init__(self, config_file: str, compile: bool = False):
        ...
        # config._target_ = "sam3d_objects.pipeline.inference_pipeline_pointmap.InferencePartPipelinePointMap"
        # config._target_ = "sam3d_objects.pipeline.inference_pipeline_pointmap.InferencePartPipelinePointMap_ultrashape"
        config._target_ = "sam3d_objects.pipeline.inference_pipeline_pointmap.InferencePartPipelinePointMap_compress"
        # config._target_ = "sam3d_objects.pipeline.inference_pipeline_pointmap.InferencePartPipelinePointMap_compress_ultrashape_pos"
        check_hydra_safety(config, WHITELIST_FILTERS, BLACKLIST_FILTERS)
        # self._pipeline: InferencePartPipelinePointMap = instantiate(config)
        # self._pipeline: InferencePartPipelinePointMap_ultrashape = instantiate(config)
        self._pipeline: InferencePartPipelinePointMap_compress = instantiate(config)
        # self._pipeline: InferencePartPipelinePointMap_compress_ultrashape_pos = instantiate(config)
    ...
    def __call__(
        ...
        global_ss: Optional[Union[None, np.ndarray]],
